...
final class Cinema {
    ...
    // NG: constants
    static final Color COLOR_PURPLE             = new Color( 50,   0, 100);
    ...
    void openShowtimes() {
        ...
        frameShowtimes.setTitle("Showtimes -- Cinéma Saint-Ford");
        ...
        lblHeader.setIcon( new ImageIcon( new ImageIcon("images/header/header.png").getImage().getScaledInstance(900, -1, Image.SCALE_SMOOTH) ) );
